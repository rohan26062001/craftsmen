        ...
        <section className="hero carousel-hero">
            ...
            >
                ...
                <div className="carousel-inner h-100">
                    ...
                    {sliderItems.map((item) => (
                        <div key={item.id} className={`carousel-item ${item.isActive ? "active" : ""}`}
                            style={{ backgroundImage: `url(${item.img})` }}>
                            <div className="carousel-caption my-auto text-center ">
                                <h1 className="hero-headline white text-center">{item.title}</h1>
                                <h3 className="hero-subhead white text-center">{item.desc}</h3>
                                <div className="slider-btns mt-4">
                                    <button className="btn btn-1 btn-primary btn-lg">Shop Now</button>
                                </div>
                            </div>
                        </div>
                    ))}
